...
<body>
    <nav class="top-nav">
        ...
        <div class="nav-section">
            ...
            <a href=""""),_display_(/*60.23*/_root_/*60.29*/.products.routes.ProductController.showForm()),format.raw/*60.74*/("""">Products</a>
            <a href=""""),_display_(/*61.23*/_root_/*61.29*/.cart.routes.CartController.showCart()),format.raw/*61.67*/("""">Cart</a>
            <a href=""""),_display_(/*62.23*/_root_/*62.29*/.coupons.routes.CouponController.showForm()),format.raw/*62.72*/("""">Coupons</a>
            <a href=""""),_display_(/*63.23*/_root_/*63.29*/.notifications.routes.NotificationController.showForm()),format.raw/*63.84*/("""">Notifications</a>
            <a href=""""),_display_(/*64.23*/_root_/*64.29*/.analytics.routes.AnalyticsController.dashboard()),format.raw/*64.78*/("""">Analytics</a>
        </div>
        <div class="nav-divider"></div>
        <div class="nav-section">
            <span class="nav-label">Advanced</span>
            <a href=""""),_display_(/*69.23*/_root_/*69.29*/.orders.routes.OrderController.showForm()),format.raw/*69.70*/("""">Orders</a>
            <a href=""""),_display_(/*70.23*/_root_/*70.29*/.reviews.routes.ReviewController.showForm()),format.raw/*70.72*/("""">Reviews</a>
            <a href=""""),_display_(/*71.23*/_root_/*71.29*/.workflow.routes.WorkflowController.showBoard()),format.raw/*71.76*/("""">Workflow</a>
            <a href=""""),_display_(/*72.23*/_root_/*72.29*/.ledger.routes.LedgerController.showLedger()),format.raw/*72.73*/("""">Ledger</a>
        </div>
    </nav>
